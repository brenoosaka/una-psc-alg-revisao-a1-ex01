...
public class Lista4 {
    public static void main(String[] args) {
        ...
        System.out.println(
                "Teve algum dos sintomas recentemente? (dor de cabeça, febre, náusea, dor articular, gripe)(S/N)");
        ...
        while (!Sintomas.equalsIgnoreCase("S") && !Sintomas.equalsIgnoreCase("N")) {
            ...
            System.out.println(
                    "Resposta inválida. Tente novamente. Teve algum dos sintomas recentemente? (dor de cabeça, febre, náusea, dor articular, gripe)(S/N)");
        ...
        while (!Contato.equalsIgnoreCase("S") && !Contato.equalsIgnoreCase("N")) {
            ...
            System.out.println(
                    "Resposta inválida. Tente novamente. Você teve contato com pessoa infectada nos últimos 14 dias? (S/N)");
        ...
        while (!Viagem.equalsIgnoreCase("S") && !Viagem.equalsIgnoreCase("N")) {
            ...
            System.out.println(
                    "Resposta inválida. Tente novamente. Está retornando de viagem realizada no exterior?(S/N)");
        ...
        if (Viagem.equalsIgnoreCase("S")) {
            System.out.println(
                    "Está retornando de viagem recentemente: " + Viagem
                            + ", então você ficará em observação por 5 dias ");

        } else {
            System.out.println("Esta retornando de viagem recentemente: " + Viagem);

        }
        System.out.println("A probabilidade de infecção e: " + porcentagem + ("%"));
        if (porcentagem <= 30) {
            System.out.println(
